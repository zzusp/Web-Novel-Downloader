...
app = BUNDLE(
    ...
    icon=None,
    bundle_identifier='com.webnoveldownloader.app',
    info_plist={
        'CFBundleName': 'Web Novel Downloader',
        'CFBundleDisplayName': 'Web Novel Downloader',
        'CFBundleIdentifier': 'com.webnoveldownloader.app',
        'CFBundleVersion': '0.4.0',
        'CFBundleShortVersionString': '0.4.0',
        'CFBundleExecutable': 'web-novel-downloader',
