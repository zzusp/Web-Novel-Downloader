#!/usr/bin/env python3
"""
Scraper - Simple web scraper script.

This script provides a simple interface for scraping web pages using XPath expressions.
"""
...
from book_downloader.scraper import main as async_scraper_main
...
def main():
    ...
    try:
        asyncio.run(async_scraper_main())
